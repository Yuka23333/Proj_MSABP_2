...
# 6) export
EXPORT_PATH = Path(__file__).resolve().parents[2] / "results" / "processed" / "antenna_polygon_vertices.json"
...
shapes = (
    ...
    (Substrate_Top, dict(fill=False, color="black")),
    (Substrate_Bottom, dict(fill=False, color="black")),
